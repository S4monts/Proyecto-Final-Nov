    ...
    private void actionEvent(ActionEvent e){
        ...
        if(evt.equals(btnCuerda)){
            ...
            MenuController.desc1 = "La guitarra es un instrumento\n"
                    ...
                    + "notas.";
            MenuController.desc2 = "Es un instrumento musical de\n"
                    + "cuerda pulsada, normalmente\n"
                    + "de 4 cuerdas que pueden ser\n"
                    + "dobles y que se asemeja en su\n"
                    + "forma a la guitarra aunque es de\n"
                    + " bastante menor tamaño. Su\n"
                    + "afinación y sonido son peculiares\n"
                    + "por lo que destaca mucho entre\n"
                    + " otros instrumentos.";
            MenuController.desc3 = "El arpa​ es un instrumento de\n"
                    + " cuerda pulsada formado por un\n"
                    + "marco resonante y una serie \n"
                    + "variable de cuerdas tensadas \n"
                    + "entre la sección inferior y \n"
                    + "la superior."
                    + "";
            LoadStage("Menu.fxml", e);
        }
